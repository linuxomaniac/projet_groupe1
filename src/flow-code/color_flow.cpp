...
void MotionToColor(CFloatImage motim, CByteImage &colim, float maxmotion)
{
    ...
    //maxrad = 4.67; // Dimetrodon exacte
    //maxrad = 9.375; // Venus exacte
    //maxrad = 11.12; // Hydrangea exacte
    //maxrad = 4.61; // RubberWhale exacte
    //maxrad = 17.6141; // Urban3 exacte
    //maxrad = 5.031; // Grove2 exacte
    maxrad = 15;
//    if(maxrad > 15)
//        maxrad = 15;
